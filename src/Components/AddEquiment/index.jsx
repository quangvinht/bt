...
export default function AddEquiment() {
    ...
    const [codeEquiment , setCodeEquiment] = useState()
    const [nameEquiment , setNameEquiment] = useState()
    

    const [ipEquiment , setIpEquiment] = useState()

    
    const [userEquiment , setUserEquiment] = useState()
    const [passwordEquiment , setPassWordEquiment] = useState()
    const [serviceEquiment , setServiceEquiment] = useState()
   ...
   const defaultOption = 'Chọn loại thiết bị';
