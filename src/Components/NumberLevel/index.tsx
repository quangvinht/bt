    ...
    'Tất cả', 'Kiosk', 'Hệ thống'
       ...
       /////
        ...
        const handleDropdownValue = (e:any)=>{
                ...
                if(e.value == "Đang chờ"){
                    const filterdata =  dataNumberLevel.filter( (item:any) =>  item.stateFilter === "Đang chờ")
                    ...
                    const filterdata =  dataNumberLevel.filter((item:any)  =>  item.stateFilter === "Đã sử dụng")
                    setData(filterdata)
                }
                else if(e.value == "Bỏ qua"){
        
                    const filterdata =  dataNumberLevel.filter((item:any)  =>  item.stateFilter === "Bỏ qua")
                    setData(filterdata)
                    ...
                    const filterdata =  dataNumberLevel.filter((item:any)  =>  item.source === "Kiosk")
                    setData(filterdata)
                }
                else if(e.value == "Hệ thống"){
        
                    const filterdata =  dataNumberLevel.filter((item:any) =>  item.source === "Hệ thống")
                    setData(filterdata)
                }
